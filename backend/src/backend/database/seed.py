...
def seed_bookings(
    ...
    bookings_data = [
        # Booking 1: Past completed booking (7 days ago)
        {
        ...
        # Booking 2: Completed last month (30 days ago)
        {
        ...
        # Booking 3: Completed 2 weeks ago
        {
        ...
        # Booking 5: Active rental (delivered yesterday, pickup tomorrow)
        {
        ...
        # Booking 7: Confirmed for tomorrow
        {
            "customer_id": customer_ids["Emily Martinez"],
            "delivery_date": today + timedelta(days=1),
        ...
        # Booking 8: Confirmed for day after tomorrow (unassigned - no driver)
        {
        ...
        # Booking 9: This weekend (3 days out)
        {
            "customer_id": customer_ids["Amanda Garcia"],
            "delivery_date": today + timedelta(days=3),
            "pickup_date": today + timedelta(days=5),
        ...
        # Booking 10: Future booking next weekend (5 days out)
        {
            "customer_id": customer_ids["Michael Brown"],
        ...
        # Booking 11: Next week Monday (7 days out)
        {
            "customer_id": customer_ids["Emily Martinez"],
            "delivery_date": today + timedelta(days=7),
        ...
        # Booking 12: Pending booking (10 days out)
        {
            "customer_id": customer_ids["Amanda Garcia"],
        ...
        # Booking 13: Future booking in 2 weeks (14 days out)
        {
            "customer_id": customer_ids["David Thompson"],
            "delivery_date": today + timedelta(days=14),
        ...
        # Booking 14: Future booking (17 days out)
        {
            "customer_id": customer_ids["David Thompson"],
            "delivery_date": today + timedelta(days=17),
            "pickup_date": today + timedelta(days=19),
            "delivery_time_window": "10:00 AM - 12:00 PM",
            "pickup_time_window": "2:00 PM - 4:00 PM",
        ...
        # Booking 15: Future booking (20 days out)
        {
            "customer_id": customer_ids["Jessica Williams"],
            "delivery_date": today + timedelta(days=20),
            "pickup_date": today + timedelta(days=22),
            "delivery_time_window": "9:00 AM - 11:00 AM",
            "pickup_time_window": "4:00 PM - 6:00 PM",
